...
public final class MensagemDAO {
     ...
     * @param codigoTurma the codigo da turma
     * @return the boolean
     */
//Enviar mensagem para a turma
    public static boolean enviarMensagem(String texto, String codigoTurma){
        boolean verificador;
        try {
            ...
            AcessoFirebase.getFirebase().child("chat").child(codigoTurma).push().setValue(mensagem);
            verificador = true;
